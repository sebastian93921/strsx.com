    ...
    <main class="main-container">
      <div class="main wrapper clearfix">
        ...
        <article id="resumeData">
            ...
            <section id="experience" class="list">
                ...
                <section>
                    ...
                    <p></p><ul>
                      ...
                      <li><b>Designed and shipped an autonomous, LLM-driven penetration-testing platform</b> that plans, executes, and validates full attack chains (RCE, JWT forgery, SSRF, account-takeover, business-logic abuse), with captured proof-of-concept evidence.</li>
                      <li><b>Established a repeatable ground-truth benchmark</b> (6 vulnerable reference apps) proving ~97% verified detection — exceeding commercial agentic-AI services and 4–7× the recall of traditional DAST scanners.</li>
            ...
            <section id="education" class="list">
                <h2>Education</h2>
