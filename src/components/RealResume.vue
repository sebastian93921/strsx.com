            ...
            <section id="experience" class="list">
                ...
                <section>
                    ...
                    <p></p><ul>
                      ...
                      <li><b>Designed and executed</b> Designed and executed advanced attack simulations using tunneled traffic to <b>evaluate leading EDR solutions</b> under SSL inspection, uncovering multiple bypasses and control gaps</li>
