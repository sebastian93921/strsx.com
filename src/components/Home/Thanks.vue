...
const codeArrays = ref([
    ...
    {line: 31, code:"&nbsp&nbsp.with(\"<span style='color: var(--yellow);'>IntersectionObserver</span>\")"},
    {line: 32, code:"&nbsp&nbsp.and(\"<span style='color: var(--yellow);'>Native CSS Animations</span>\")"},
    {line: 33, code:"}"},
    {line: 34, code:""},
